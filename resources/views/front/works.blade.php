...
@section('content')
		...
		<section id="slider" class="slider-element swiper_wrapper min-vh-40 min-vh-md-75" data-autoplay="9000" data-speed="800" data-loop="true" data-grab="false">
			<div class="slider-inner" style="transform: translate3d(0px, 0px, 0px);">
						...
						<div class="swiper-slide dark swiper-slide-active" role="group" aria-label="1 / 3" style="width: 1226px;">
							<div class="container">
								<div class="slider-caption slider-caption-center" style="transform: translate3d(0px, 0px, 0px); opacity: 1;">
									<h2 data-animate="fadeInUp" class="fadeInUp animated">@lang('home.Works')</h2>
								</div>
							</div>
                ...
                <div class="swiper-slide-bg" style="background-image: url('{{asset('front/')}}/images/slider/swiper/Our-works.jpg');"></div>
			</div>
		</section>
		<!-- #Slider End -->
...
@foreach($works as $work)
                        ...
                        <div class="col-sm-6 col-lg-6 p-3">
                            <div class="feature-box media-box">
                                <div class="fbox-media">
                                     <a href="{{route('trade')}}"><img src="{{asset('front/')}}/images/slider/swiper/Trading-front.jpg"  style="width: 530px; height: 330px !important" alt="Why choose Us?"></a>
                                </div>
                                <div class="fbox-content px-0">
                                   <a href=""> <h3>{{$work2->getName()}}</h3></a>
                                    <p>{{$work2->getDescription()}}</p>
                                </div>
                            </div>
                        </div>
