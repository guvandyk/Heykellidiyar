                ...
                <section id="page-title">
                    <div class="container clearfix">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="{{route('category',$category->slug)}}">{{$category->getName()}}</a></li>
                        </ol>
                    </div>
						...
						<div class="row clearfix">
							<div class="col-lg-5">
								<div id="oc-images" class="pt-5">
                                    <img src="{{asset($Items->image)}}" style="width: 440px; height: 315px !important" alt="Image 1">
                                </div>
							</div>
