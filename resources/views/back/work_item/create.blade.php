                        ...
                        <div class="card">
                            ...
                            @endif
                                        <div class="card-title">
                                            <h3 class="text-center">Добавить Услуг</h3>
                                        </div>
                                        <hr>
                                        <form action="{{route('admin.work_Item.store')}}" method="POST" enctype="multipart/form-data">
                                           @csrf
                              ...
                              <select class="form-control" name="category_id" required>
                                  ...
                                  <option value="{{$work->id}}">{{$work->slug}}</option>
                                  @endforeach
